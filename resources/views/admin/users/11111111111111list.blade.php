...
<div class="table-responsive">
    ...
    <table>
        <thead>
            <tr>
                <th style="background: #000;"><span>Corporate Name:</span>{{$userss->login_id ?? ''}} <a data-bs-toggle="modal" data-bs-target="#editcompanydetails{{$userss->id}}"> <i class="font-20 bx bxs-edit"></i></a></th>
...
@endphp
   ...
   Total Certificate:<a href="{{route('getFoSTaCDocuments',[$userss->id,1,'Corporate'])}}">{{$totalEmployeDocuments ?? 0}}</a>
