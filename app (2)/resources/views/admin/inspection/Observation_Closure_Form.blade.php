    ...
    <div class="main-container">
        <div class="details-container">
            <div class="form-group">
                ...
                <div class="mb-3"><label for="correctiveAction" class="form-label header">Corrective Action Taken:</label>
                
                 <p class="reopenbox">This will create a <strong>new open observation</strong> based on the previous one. Please provide the reason and new evidence.</p>
                <textarea class="form-control" id="correctiveAction1" rows="4"></textarea></div>
                
                
                <div class="form-group-header">
                    <label class="form-label filelable" for="complaint-box">Choose Image <span class="required-star">*</span></label>
                </div>
