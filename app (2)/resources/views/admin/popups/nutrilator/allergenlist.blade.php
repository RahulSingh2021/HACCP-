                      <table class="table table-bordered table-striped mt-4">
                                            ...
                                            <tbody>
												...
												@php $i=1; @endphp
												@foreach($Ingredients as $refrencess)
...
<img src="{{config('app.url').'/companylogo/'.$refrencess->company_logo}}" width="40px;" >
                @endif</td>
                                                ...
                                                <td> <i class="font-20 bx bxs-edit" data-bs-toggle="modal" data-bs-target="#editDataRefrenceName{{$refrencess->id}}"></i>  <a href="{{route('deleteproduct_allergen',$refrencess->id)}}"><i class="font-20 bx bxs-trash"></i></a></td>
