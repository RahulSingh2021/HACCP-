  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3 header-title">Category Update Form</h4>
                    <form class="required-form" action="{{url('admin/add-new-category/update-main-category',$edit->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
