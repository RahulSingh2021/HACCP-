...
<div class="row">
        ...
        <div id="imagePreview"></div>
                                        ...
                                        <div class="col-8 align-self-center title-box">
                                            ...
                                            <div data-bs-toggle="tooltip" data-bs-placement="right" title="" class="content-editable-block"  contenteditable="true" placeholder="Add a description" tabindex="0" data-bs-original-title="Describe your template" aria-label="Describe your template" id="templatedesc">{{$template_details->template_desc ?? ''}}</div>
                                        </div>
...
<ul id="optionsList">
    @foreach($multipleoptionList as $multipleoptionLists)
        ...
        <li onclick="selectResponse(this, '{{ $multipleoptionLists->id }}')"
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <tr>
                                                                            <td class="d-flex align-items-center" style="border:none;">
                                                                             <div class="darg-icon"><svg viewBox="0 0 24 24" width="24" height="24" focusable="false"><path fill="none" d="M0 0h24v24H0V0z"></path><path fill="#333" d="M11 18c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm-2-8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 4c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"></path></svg></div>    
                                                                             <span class="required-icon">*</span> 
                                                                             <div class="content-editable-block w-100 fr1" onkey="questionsave()" contenteditable="true" placeholder="Conducted on" tabindex="0"></div>
                                                                            </td>
                                                                          <td>
    <!-- Default options initially displayed -->
    <div class="defaultbox" style="float: left;">
...
<ul id="optionsList">
    @foreach($multipleoptionList as $multipleoptionLists)
        ...
        <div class="pena-sec"><a href="" data-bs-toggle="offcanvas" data-bs-target="#2rightSlide{{$multipleoptionLists->unique_id}}"><i class="bx bx-edit me-0"></i></a></div>
        
        
   <!-- Right Sidebar Blind Slide -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="2rightSlide{{$multipleoptionLists->unique_id}}" aria-labelledby="rightSlideLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="rightSlideLabel">Multiple choice responses</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
...
@foreach($list as $index => $lists)
    <div class="responce-input d-flex align-items-center">
        <input type="text" name="responses1[{{ $index }}][text]" class="form-control" placeholder="Response 1" value="{{ $lists->name }}">
        <input type="text" name="responses1[{{ $index }}][id]" class="form-control" value="{{ $lists->id }}">
        <input type="text" name="responses1[{{ $index }}][unique_id]" class="form-control" value="{{ $multipleoptionLists->unique_id }}">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <tr>
                                                                            <td class="d-flex align-items-center" style="border:none;">
                                                                             <div class="darg-icon"><svg viewBox="0 0 24 24" width="24" height="24" focusable="false"><path fill="none" d="M0 0h24v24H0V0z"></path><path fill="#333" d="M11 18c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm-2-8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 4c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"></path></svg></div>    
                                                                             <span class="required-icon">*</span> 
                                                                             <div class="content-editable-block w-100 fr1" onkey="questionsave()" contenteditable="true" placeholder="Prepared by" tabindex="0"></div>
                                                                            </td>
                                                                           <td>
    <!-- Default options initially displayed -->
    <div class="defaultbox" style="float: left;">
...
<ul id="optionsList">
    @foreach($multipleoptionList as $multipleoptionLists)
        ...
        <div class="pena-sec"><a href="" data-bs-toggle="offcanvas" data-bs-target="#3rightSlide{{$multipleoptionLists->unique_id}}"><i class="bx bx-edit me-0"></i></a></div>
        
        
   <!-- Right Sidebar Blind Slide -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="3rightSlide{{$multipleoptionLists->unique_id}}" aria-labelledby="rightSlideLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="rightSlideLabel">Multiple choice responses</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <tr>
                                                                            <td class="d-flex align-items-center" style="border:none;">
                                                                             <div class="darg-icon"><svg viewBox="0 0 24 24" width="24" height="24" focusable="false"><path fill="none" d="M0 0h24v24H0V0z"></path><path fill="#333" d="M11 18c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm-2-8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 4c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"></path></svg></div>    
                                                                             <span class="required-icon">*</span> 
                                                                             <div class="content-editable-block w-100 fr1" onkey="questionsave()" contenteditable="true" placeholder="Location" tabindex="0"></div>
                                                                            </td>
                                                                            <td>
    <!-- Default options initially displayed -->
    <div class="defaultbox" style="float: left;">
...
<ul id="optionsList">
    @foreach($multipleoptionList as $multipleoptionLists)
        ...
        <div class="pena-sec"><a href="" data-bs-toggle="offcanvas" data-bs-target="#4rightSlide{{$multipleoptionLists->unique_id}}"><i class="bx bx-edit me-0"></i></a></div>
        
        
   <!-- Right Sidebar Blind Slide -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="5rightSlide{{$multipleoptionLists->unique_id}}" aria-labelledby="rightSlideLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="rightSlideLabel">Multiple choice responses</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
...
<div class="drop-contant">
                                        ...
                                        <path d="M13 5C13 4.44772 12.5523 4 12 4C11.4477 4 11 4.44772 11 5V11H5C4.44772 11 4 11.4477 4 12C4 12.5523 4.44772 13 5 13H11V19C11 19.5523 11.4477 20 12 20C12.5523 20 13 19.5523 13 19V13H19C19.5523 13 20 12.5523 20 12C20 11.4477 19.5523 11 19 11H13V5Z" fill="currentColor"></path>
                                                                    ...
                                                                    <button class="title-btn2 Addsection" ><svg width="1.125rem" height="1.125rem" viewBox="0 0 14 14" focusable="false">
                                        <g transform="translate(1 1)" fill="#6559ff" fill-rule="nonzero">
                                            <rect width="12" height="4.066" rx="0.733"></rect>
                                            <path d="M.8 5.947v5.164h10.4V5.947H.8zm0-.89h10.4c.442 0 .8.399.8.89v5.164c0 .491-.358.889-.8.889H.8c-.442 0-.8-.398-.8-.889V5.947c0-.491.358-.89.8-.89z">
                                            </path>
                                        </g>
...
$('#question_' + questionId + ' .fRTxQu').show();
    ...
    $("#accordionFlushExample").on("click", ".delete-question", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                $(`#question_${questionId}`).remove(); // Remove the question row from the table
            },
            error: function (xhr, status, error) {
...
function selectResponse(listItem, value) {
