                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link  active " href="{{route('responsibility')}}">
                                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="tab-content">
                                       ...
                                       <div class="tab-pane fade  show active" id="Authority" role="tabpanel">
...
@endif
                                                ...
                                                <tbody>
                                                  ...
                                                  <tr id="responsibility_detailss_{{$authoritys->id}}">
                                                    ...
                                                    {{$authoritys->name}} ({{Helper::userInfoShortName($authoritys->unit_id ?? '')}})
                    ...
                    <div class="row">
                        ...
                        <div class="mb-12 col-md-12">
                            <label class="form-label"> Responsibility Name:</label>
                              ...
                              @if(Auth::user()->id == $authoritys->unit_id)
                                 <input type="text" class="form-control"  name="name" placeholder="" value="{{$authoritys->name}}">
                                 
                                 @else
                                 
                                 <input type="text" class="form-control"  name="name" placeholder="" readonly value="{{$authoritys->name}}">
...
{{$location_lists->name}}({{Helper::userIfo($location_lists->created_by ?? '')}})
</option>

@else
<option value="{{$location_lists->id}}" > 

{{$location_lists->name}}({{Helper::userIfo($location_lists->unit_id ?? '')}})
