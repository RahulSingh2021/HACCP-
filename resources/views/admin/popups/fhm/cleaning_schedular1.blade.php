    ...
    @if($is_role !="2")
                                            ...
                                            <table class="table table-bordered table-striped mt-4" id="pm-schedule-maker_table">
                                                ...
                                                <tbody>
													...
													@php $k=1; @endphp
													@foreach($schedulemakerlist1 as $schedulemakerlists)
                                                <tr id="cleaning_schedular1_detailss_{{$schedulemakerlists->id}}">
                                       <td><input class="checkboxcleaning_schedularvalue1" type="checkbox" value="{{ $schedulemakerlists->id }}"></td>
                                                    <td>{{$k}}</td>
                                                    ...
                                                    <td><?php 
														...
														?></td>
                                                    <td>
														<i data-bs-toggle="modal" data-bs-target="#editcleaningpm{{$schedulemakerlists->id}}" class="font-20 bx bxs-edit" style="cursor:pointer;"></i>
													  ...
													  <div class="modal fade" id="editcleaningpm{{$schedulemakerlists->id ?? ''}}" tabindex="-1" aria-hidden="true">
