    ...
    <div class="main-container">
        <div class="details-container">
            <div class="form-group">
                ...
                <div class="mb-3">
                    <p>This will create a <strong>new open observation</strong> based on the previous one. Please provide the reason and new evidence.</p>
                    <label for="correctiveAction" class="form-label">Reason for Non-Compliance:
</label><textarea class="form-control" id="correctiveAction1" rows="4"></textarea></div>
                
                
                <div class="form-group-header">
                    <label class="form-label" for="complaint-box">Upload New "Before" Photo:<span class="required-star">*</span></label>
                </div>
