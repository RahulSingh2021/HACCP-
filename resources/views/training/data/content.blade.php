...
<head>
    ...
    <style>
        ...
        /* Table Styles */
        .table-container { max-width: 95%; margin: 20px auto 0; overflow-x: auto; border: 1px solid var(--border-color); box-shadow: 0 6px 20px rgba(0, 0, 0, 0.1); border-radius: 10px; max-height: 70vh; }
        ...
        #role-wise-chart-wrapper .role-x-axis-main-label { white-space: normal; word-break: break-word; padding: 5px; font-size: 0.9em; font-weight: 600; border-bottom: 1px solid #ccc; margin: 0 5px; }
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* START: Responsive Table "Card Stacking" Style */
            .interactive-table {
                border: none;
            }
            ...
            .interactive-table .hierarchy-col::before {
                display: none; /* The hierarchy column doesn't need a "label" */
            }
            /* END: Responsive Table "Card Stacking" Style */
...
<body>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        let lastScrollState = null; // Used to restore scroll position after a data update.
        ...
        function initializeAllCharts() {
            ...
            function calculateTimelineChartData() {
                ...
                const granularity = document.querySelector('.chart-granularity-selector .active').dataset.granularity;
                const periods = parseInt(document.querySelector('.timeline-periods-input').value, 10) || 2;
                ...
                dashboardContainer.addEventListener('click', (e) => {
                    ...
                    if (button) {
                        ...
                        if (button.parentElement.classList.contains('chart-granularity-selector')) {
                            ...
                            // Only process for dynamic charts
                        ...
                        // Handle refresh button
                             ...
                             // Only process for dynamic charts
                             if (button.closest('.timeline-chart-wrapper').id !== 'role-wise-chart-wrapper') {
                               renderAll();
                             }
                        }
                    }

                    // START FIX: Handle legend toggle for both series and hierarchy
                    ...
                    if (legendItem) {
                        ...
                        if (isHierarchy) {
                            ...
                            // Sync all legends with the same label
                            document.querySelectorAll(`.legend-item[data-hierarchy-label="${label}"]`).forEach(item => {
                            ...
                            // Only re-render the affected chart
                            renderStackedBarChart(chartDataCache);
                        }
                    }
                    // END FIX
                    ...
                    if (downloadAction) {
                        ...
                        handleChartDownload(chartId, format);
                    }
                });
        ...
        function renderAllChartsHtml() {
            ...
            <div id="role-wise-chart-wrapper" class="timeline-chart-wrapper">
                <div class="chart-container" style="padding: 1.5rem;">
                     <div class="chart-header">
                        <h2 id="role-wise-chart-title" class="chart-title">Role Wise Training Status (Static Preview)</h2>
                    </div>
                    <div class="role-chart-container">
                        <div class="role-chart-grid">
                            <div class="role-y-axis" style="justify-content: space-between;">
                                <span>100</span><span>80</span><span>60</span><span>40</span><span>20</span><span>0</span>
                            </div>
                            <div class="role-chart-area" style="background-image: none; border-bottom: 1px solid #c9c9c9;">
                                <!-- Dummy bars -->
                                <div class="role-bar-group">
                                    <div class="role-bar-stack" style="width: 50%;">
                                        <div class="role-bar-segment" style="height: 60%; background-color: #4472c4;" title="Engineers: 60 Attended"></div>
                                        <div class="role-bar-segment" style="height: 15%; background-color: #ed7d31;" title="Chefs: 15 Attended"></div>
                                    </div>
                                </div>
                                <div class="role-bar-group">
                                    <div class="role-bar-stack" style="width: 50%;">
                                        <div class="role-bar-segment" style="height: 40%; background-color: #4472c4;" title="Engineers: 40 Attended"></div>
                                        <div class="role-bar-segment" style="height: 35%; background-color: #ed7d31;" title="Chefs: 35 Attended"></div>
                                    </div>
                                </div>
                                <div class="role-bar-group">
                                    <div class="role-bar-stack" style="width: 50%;">
                                         <div class="role-bar-segment" style="height: 80%; background-color: #4472c4;" title="Engineers: 80 Attended"></div>
                                        <div class="role-bar-segment" style="height: 10%; background-color: #ed7d31;" title="Chefs: 10 Attended"></div>
                                    </div>
                                </div>
                                <!-- Dummy line points (using absolute positioning) -->
                                <div style="position:absolute; bottom: 30%; left: 16%; width:8px; height:8px; background-color:#a5a5a5; border-radius:50%;" title="Missed: 30"></div>
                                <div style="position:absolute; bottom: 50%; left: 49%; width:8px; height:8px; background-color:#a5a5a5; border-radius:50%;" title="Missed: 50"></div>
                                <div style="position:absolute; bottom: 20%; left: 82%; width:8px; height:8px; background-color:#a5a5a5; border-radius:50%;" title="Missed: 20"></div>
                            </div>
                            <div class="role-y-axis-right" style="justify-content: space-between;">
                                <span>50</span><span>40</span><span>30</span><span>20</span><span>10</span><span>0</span>
                            </div>
                        </div>
                        <div class="role-x-axis" style="padding-left:0; padding-right:0;">
                           <div class="role-x-axis-group" style="border:none;"><div class="role-x-axis-main-label">Period 1</div></div>
                           <div class="role-x-axis-group"><div class="role-x-axis-main-label">Period 2</div></div>
                           <div class="role-x-axis-group"><div class="role-x-axis-main-label">Period 3</div></div>
                        </div>
                    </div>
                    <div id="role-wise-chart-legend" class="legend">
                        <div class="legend-item"><span class="legend-key" style="background-color: #4472c4;"></span><span>Engineer (Attended)</span></div>
                        <div class="legend-item"><span class="legend-key" style="background-color: #ed7d31;"></span><span>Chef (Attended)</span></div>
                        <div class="legend-item"><span class="legend-key role-legend-key-line" style="border-color: #a5a5a5;"></span><span>Missed Sessions</span></div>
                    </div>
                </div>
            </div>
            `;
        ...
        function updateRoleWiseChart() {
            // This chart is now a static preview. No update logic is needed.
        }
        ...
        function flattenHierarchy(nodes, level = 1) {
            return nodes.flatMap(node => {
                ...
                return [row, ...(isExpanded && node.children ? flattenHierarchy(node.children, level + 1) : [])];
            });
        }
        ...
        function renderRow(rowData, serialNumber, catalogToRender) {
            const { id, displayName, level, type, summary, hasChildren, isExpanded, isVisible, isPaginatedVisible, status, role, joiningDate, employeeIdNum, fullPath } = rowData;
            ...
            for (const topic in catalogToRender) {
                ...
                if (isColExpanded) {
                    metricCellsHtml += subtopicsInCatalog.map(subtopicName => {
                        ...
                        // MODIFICATION: Check if the row is an employee to decide which cell type to render.
                        if (rowData.type === 'employee') {
                            // Employee rows get the detailed competency bar for editing.
                            if (sessions.length > 0) {
                             ...
                             // Summary rows get the new "Overall Summary" style cell.
                        ...
                        return `<td data-label="${subtopicName}">${cellContent}</td>`;
                    ...
                    // MODIFICATION: Use the new topic summary cell for collapsed topic columns as well.
                    metricCellsHtml += `<td class="summary-col" colspan="1" data-label="${topic} Summary">${renderTopicSummaryCell(groupSummary)}</td>`;
                }
            }
            
            const rowClass = type === 'employee' ? 'employee' : `${type} ${hasChildren ? 'expandable' : ''}`;
            const hierarchyColAction = type !== 'employee' ? `data-action="toggle-row" data-id="${id}"` : '';
            return `<tr data-id="${id}" data-level="${level}" class="${rowClass}"><td class="hierarchy-col" ${hierarchyColAction}>${hierarchyCellHtml}</td> <td class="overall-summary-col" data-label="Overall Summary">${renderCell(summary, rowData)}</td> ${metricCellsHtml} </tr>`;
        }
        ...
        function processViewData() {
            ...
            let flatData = flattenHierarchy(prunedNodes, 1);
...
<div class="signature-section"><div><div class="signature-label">Employee Signature</div><div class="signature-box"></div><div class="signature-name">Ganesh Yadav</div><div class="signature-details">ID: 151-002246 | Date: 05-Jul-2023</div></div><div><div class="signature-label">HR Manager Approval</div><div class="signature-box"><img src="data:image/svg+xml;base64," class="signature-stamp" alt="Approved Stamp"></div><div class="signature-name">Priya Sharma</div><div class="signature-details">HR Manager | Training Department</div></div></div><div class="footer-note"><div class="qr-code"><img src="data:image/svg+xml;base64," alt="QR Code">Scan to verify</div>This document is system generated and valid without physical signature.<br>For verification, please contact HR department at hr@company.com or call +91 1800 123 4567<br>© 2023 Company Name. All rights reserved.</div>
            ...
            if (action === 'toggle-row' || action === 'toggle-column') {
                const tableContainer = document.querySelector('.table-container');
                const scrollPos = tableContainer ? tableContainer.scrollTop : 0;
                if (action === 'toggle-row') {
                    state.ui.expandedRows.has(id) ? state.ui.expandedRows.delete(id) : state.ui.expandedRows.add(id);
                } else {
            ...
            if (action === 'change-page') { state.ui.pagination.currentPage += parseInt(actionTarget.dataset.direction); }
            if (action === 'change-rows-per-page') { state.ui.pagination.rowsPerPage = parseInt(e.target.value); state.ui.pagination.currentPage = 1; }

            if (actions[action]) { e.preventDefault(); actions[action](); }
            if (shouldReprocess) { reprocessAndRender(); } else if (action.startsWith('toggle-') || action.startsWith('change-')) { render(renderOptions); }
        }
        ...
        function downloadSummaryExcel() { 
            ...
            const summaryData = flattenHierarchy(prunedNodes, 1);
