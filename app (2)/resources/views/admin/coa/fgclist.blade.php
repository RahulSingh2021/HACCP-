...
@include('admin.popups.cop.fgc')
            ...
            <div class="tab-title">COA</div>
                            ...
                            <li class="nav-item " role="presentation" style="margin:5px;">
            <a class="nav-link active" data-bs-toggle="pill" href="#company-details1" role="tab" aria-selected="false">
            <div class="d-flex align-items-center">
...
<h5 class="modal-title">Import FGC</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">

<form method="post" action="{{route('importFga')}}" enctype="multipart/form-data">
@csrf
<div class="row">
...
<hr>
<button type="submit" class="btn btn-primary">Add New FGA</button>
</div>
      ...
      <div class="col-sm-12 col-lg-12 mg-b-20">
                              ...
                              <button type="button" class="btn btn-outline-dark px-3" data-bs-toggle="modal" data-bs-target="#addnewuser" >+ Add FGC</button>
                              									<a href="{{config('app.url').'/companylogo/fgc.csv'}}" class="btn btn-outline-dark px-3" download >Sample Csv</a>

                              													   <button type="button" class="btn btn-outline-dark px-3" data-bs-toggle="modal" data-bs-target="#importDepartment">Import FGC Data</button>
                                                    ...
                                                    <p> <i class="font-20 bx bxs-map"></i> {{$Supplier_details->address ?? ''}} </p>
                                                 	     ...
                                                 	     <td>
														     ...
														     <td>
														         ...
														         <p><strong>Test Report Date </strong> {{$Supplier_detailslists->text1 ?? ''}}</p>
														         <p><strong>Expiry  Date </strong> {{$Supplier_detailslists->text2 ?? ''}}</p>
...
@else
    ...
    <a style="color: #000;"  data-bs-toggle="modal" data-bs-target="#uploadaudit{{$Supplier_detailslists->id}}" ><i class="font-20 bx bxs-cloud-upload"></i> Upload</a></p>

@endif

</p>
	<p><strong>Completed On</strong> {{$Supplier_detailslists->text3 ?? ''}}</p>												        
...
<a target="_blank()" href="{{asset('inspection')}}/{{$Supplier_detailslists->image2 ?? ''}}"><i class="font-20 bx bxs-file" ></i>
</a>
@else
<a style="color: #000;"  data-bs-toggle="modal" data-bs-target="#uploadh2audit{{$Supplier_detailslists->id}}" ><i class="font-20 bx bxs-cloud-upload"></i> </a></p>
@endif
</p>
                                                           </td>
	...
	<a style="color: #000;" href="{{route('fgc_delete',$Supplier_detailslists->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="font-20 bx bxs-trash"></i> </a>
...
<!-- Edit Audit Plan-->
        ...
        <div class="row">
                <input type="hidden" class="form-control"  name="edit_auditid" placeholder="" value="{{$Supplier_detailslists->id ?? ''}}" required>
                <input type="hidden" class="form-control"  name="cgc_id" placeholder="" value="{{$Supplier_detailslists->id ?? ''}}" required>
...
<h5 class="modal-title">Upload Specification:</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
<form method="post" action="{{route('auditupload')}}" enctype="multipart/form-data">
...
<div class="mb-12 col-md-12">
<label class="form-label">Upload Specification:</label>
...
<button type="submit" class="btn btn-primary">Submit</button>
        ...
        <h5 class="modal-title">Edit FGC</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
...
<input  name="brand_name" class="form-control" value="{{$Supplier_detailslists->brand_name ?? ''}}">
		   ...
		   <div class="mb-3 col-md-6">
                            ...
                            <select class="form-control"  name="supplier_id">
                                ...
                                <option value="{{$Supplier_lists->id ?? ''}}" {{ ( $Supplier_lists->id == $Supplier_detailslists->supplier_id) ? 'selected' : '' }} >{{$Supplier_lists->supplier_name ?? ''}}</option>
                                @endforeach
                            </select>
        ...
        <div class="mb-3 col-md-12 text-center">
        <hr>
        <button type="submit" class="btn btn-primary">Edit FGC</button>
        </div>
