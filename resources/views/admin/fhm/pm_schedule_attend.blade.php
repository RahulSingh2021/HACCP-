 ...
 <div class="tbale-top">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="3" class="midlle-td">Special PM Schedule</td>
            </tr>
            <tr>
                <td>Frequency: {{$facility_equipment->p_frequency}}</td>
...
<form id="myForm" action="{{ url('facility_hygiene_pmschedule_attend') }}" method="POST" enctype="multipart/form-data">
    @csrf
       ...
       $.ajaxSetup({
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                setTimeout(function() {
                    window.location.href = 'https://efsm.safefoodmitra.com/admin/public/index.php/facility-hygiene-pm-schedules';
                }, 2000); 
            },
