                <div class="modal fade" id="addcleaning" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                      <h5 class="modal-title">Add Cleaning Schedule Maker</h5>
                ...
                <div class="modal-body">
                        ...
                        <form method="post" action="{{route('schedule_maker_store')}}">
                            @csrf
                    <div class="row">
						<input type="hidden" class="form-control"  name="type" placeholder="" value="1">
