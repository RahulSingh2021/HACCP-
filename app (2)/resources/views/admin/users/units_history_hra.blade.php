                    ...
                    <div class="row hidebox">
                        ...
                        @if($document_type=="License")
                           ...
                           <input type="file" name="image" required>
                              ...
                              <div class="col-md-4 hideCertificate">
                        ...
                        <select name="cat_type" class="selectpicker" id="userlist" required="" tabindex="null">
...
<script>
  ...
  $('.show-details').click(function(){
    ...
    $(document).ready(function() {
        ...
        if ($(this).val() === 'HRA') {
            $('.hideCertificate').hide(); // Hide the div when "Calibration Discontinued" is selected
             $('.hideCertificate input').removeAttr('required');
        } else {
            $('.hideCertificate').show(); // Show the div for any other option
        }
    });
    });
