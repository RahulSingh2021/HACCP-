<div class="tab-pane fade" id="cleaning_schedule" role="tabpanel">
                                            ...
                                            <div class="row row-cols-auto g-3">
                                                ...
                                                <div class="col">
													<button type="button" class="btn btn-outline-dark px-3 " data-bs-toggle="modal" data-bs-target="#addcleaning">+</button>
													 ...
													 <button type="button" id="delbuttoncleaning_schedule" class="btn btn-danger btn-xs" value="delete">Delete Selected</button>
