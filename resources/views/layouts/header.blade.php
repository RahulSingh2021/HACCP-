                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('changePassword') }}"><i class="bx bx-user"></i><span>Reset Password</span></a>
                            </li>
    ...
    <nav class="topbar-nav">
        <ul class="metismenu" id="menu">
            ...
            @if($is_role==0)
                    ...
                    <li><a href="{{route('corporateManagement')}}" class="{{ Request::routeIs('corporateManagement') ? 'active' : '' }}"><div class="menu-title">Corporate Management</div></a></li>
                    <!--<li><a href="{{route('department')}}" class="{{ Request::routeIs('department') ? 'active' : '' }}"><div class="menu-title">Unit Management</div></a></li>-->
			  <li><a href="{{route('facility_hygiene_new')}}" class="{{ Request::routeIs('facility_hygiene_new') ? 'active' : '' }}"><div class="menu-title">Facility Hygiene</div></a></li>
			  
			  @if(Session::get('unit_id'))
			  			  <li><a href="{{route('nutrilatornew',['tab_name' => 6])}}" class="{{ Request::routeIs('nutrilatornew') ? 'active' : '' }}"><div class="menu-title">Nutrilator</div></a></li>

			  @else
			  			  <li><a href="{{route('nutrilatornew',['tab_name' => 1])}}" class="{{ Request::routeIs('nutrilatornew') ? 'active' : '' }}"><div class="menu-title">Nutrilator</div></a></li>
...
@endif
                ...
                <!--<li><a href="{{route('department')}}" class="{{ Request::routeIs('department') ? 'active' : '' }}"><div class="menu-title">Unit Management</div></a></li>-->
			  <li><a href="{{route('linces')}}" class="{{ Request::routeIs('linces') ? 'active' : '' }}"><div class="menu-title">FSSAI Complience</div></a></li>
			  <li><a href="{{route('facility_hygiene_new')}}" class="{{ Request::routeIs('facility_hygiene_new') ? 'active' : '' }}"><div class="menu-title">Facility Hygiene</div></a></li>
			  <li><a href="{{route('nutrilatornew',['tab_name' => 6])}}" class="{{ Request::routeIs('nutrilatornew') ? 'active' : '' }}"><div class="menu-title">Nutrilator</div></a></li>
        @endif
                        ...
                        <li><a href="{{route('training_data_index')}}" class="{{ Request::routeIs('training_data_index') ? 'active' : '' }}"><div class="menu-title">People Management</div></a></li>
                         <li><a href="{{route('training_data_index_new')}}" class="{{ Request::routeIs('training_data_index_new') ? 'active' : '' }}"><div class="menu-title">New People Management</div></a></li>
                        <li><a href="{{route('sqa')}}" class="{{ Request::routeIs('sqa') ? 'active' : '' }}"><div class="menu-title">SQA</div></a></li>
                        
                          <!--<li><a href="{{route('record')}}" class="{{ Request::routeIs('record') ? 'active' : '' }}"><div class="menu-title">Record</div></a></li>-->
    
                          <li><a href="{{route('record.new.index')}}" class="{{ Request::routeIs('record.new.index') ? 'active' : '' }}"><div class="menu-title">Record</div></a></li>
