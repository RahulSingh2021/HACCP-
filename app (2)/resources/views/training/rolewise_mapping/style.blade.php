 <style>
    ...
    * {
    ...
    /* Changed 'width' to 'min-width' for better flexibility */
    .col-department { min-width: 160px; }
    .col-category { min-width: 180px; }
    .col-role { min-width: 200px; }
    ...
    /* ===== STICKY TABLE STYLES START ===== */

    /* 1. Make the entire header row block sticky to the top */
    thead th {
      position: sticky;
      top: 0;
      z-index: 3; /* Must be higher than body columns */
    }
