...
<!--@include('training.rolewise_mapping.style')-->
        ...
        <ul class="tab-nav" role="tablist" id="mainTabNav">
            ...
            <li><button class="tab-button" data-tab-target="#data1" role="tab" aria-selected="false" aria-controls="data1"><i class="fas fa-calendar-alt"></i> <span>User Management</span></button></li>
            <li>
            ...
            <li><button class="tab-button" data-tab-target="#datanew" role="tab" aria-selected="false" aria-controls="datanew"><i class="fas fa-database"></i> <span>Data New</span></button></li>
              <li><button class="tab-button" data-tab-target="#tninew" role="tab" aria-selected="false" aria-controls="tninew"><i class="fas fa-database"></i> <span>TNI Mapping New</span></button></li>
...
<button class="mobile-tab-toggle" id="mobileTabToggle" aria-label="Toggle tabs"><i class="fas fa-bars"></i></button>
    ...
    <div class="tab-content">
        ...
        <div id="topic" class="tab-pane" role="tabpanel" aria-labelledby="topic-tab">
            @include('training.topiclist.content')
        </div>
        <div id="trainer" class="tab-pane" role="tabpanel" aria-labelledby="trainer-tab">
            <h2><i class="fas fa-chalkboard-teacher"></i> Trainer List</h2>
            <p>Browse the list of certified trainers. View their profiles, expertise, and availability.</p>
            <p><em>A table or card layout displaying trainer information would be suitable here.</em></p>
            
                 @include('training.trainer.content')
        </div>
        ...
        >
          <iframe 
            src="{{ route('training.data.page') }}" 
            style="position:absolute; top:0; left:0; width:100%; height:100%; border:none;"
          ></iframe>
        </div>
      
      
        <div id="calendar" class="tab-pane" role="tabpanel" aria-labelledby="calendar-tab" style="position:relative; width:100%; height:100vh;">
           <iframe 
            src="{{ route('training.calendar.page') }}" 
            style="position:absolute; top:0; left:0; width:100%; height:100%; border:none;"
          ></iframe>
        </div>
      ...
      <div 
          ...
          class="tab-pane" 
          role="tabpanel" 
          aria-labelledby="data1-tab"
          style="position:relative; width:100%; height:100vh;"
        >
          <iframe 
            src="{{ route('usermanagement') }}" 
            style="position:absolute; top:0; left:0; width:100%; height:100%; border:none;"
          ></iframe>
        </div>
         <div id="datanew" class="tab-pane" role="tabpanel" aria-labelledby="datanew-tab" style="position:relative; width:100%; height:100vh;">
             <iframe 
            src="{{ route('training.data.new.page') }}" 
            style="position:absolute; top:0; left:0; width:100%; height:100%; border:none;"
          ></iframe>
        </div>
        <div id="tninew" class="tab-pane" role="tabpanel" aria-labelledby="tninew-tab" style="position:relative; width:100%; height:100vh;">
             <iframe 
            src="{{ route('tni.mapping.new.page') }}" 
            style="position:absolute; top:0; left:0; width:100%; height:100%; border:none;"
          ></iframe>
        </div>
    </div>
