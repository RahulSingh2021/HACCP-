         ...
         <div class="card-body">
            ...
            <div class="tab-content">
               <div class="tab-pane fade  show active " id="company-details" role="tabpanel">
                  <div class="row row-cols-auto g-3" style="margin-bottom: 20px;">
                     <div class="col">
...
<div class="table-boxes tableDesign">
   <div class="1table-responsive">
    ...
    <div class="fssaiListing">
        ...
        <ul>
            <li><strong>Total Unit:</strong> <span>33</span> ( Uploaded:<span>0</span>, Not Uploaded:<span><a href="{{route('units',[$userss->id,'1','pending'])}}">{{Helper::units($userss->id,'1','pending','License')}}</a></span> )</li>
            <li><strong>Valid:</strong> <span><a href="{{route('getDocuments',[$userss->id,'Central','Corporate'])}}">{{ Helper::getDocuments($userss->id, 'Central', 'Corporate','License') }} </a></span> ( Near Expiry:<span><a href="{{route('getexpDocuments',[$userss->id,'Central','1','Corporate'])}}">{{Helper::getexpDocuments($userss->id,"Central","1","Corporate",'License')}}</a></span>, C:<span><a href="{{route('getallDocuments',[$userss->id,'Central','Corporate'])}}">{{ Helper::totalDocuments($userss->id, 'Central', 'Corporate','License') }}</a></span>, S:<span><a href="{{route('getallDocuments',[$userss->id,'State','Corporate'])}}">{{ Helper::totalDocuments($userss->id, 'State', 'Corporate','License') }}</a></span> )</li>
            <li><strong>Expired:</strong> <span>      <a href="{{route('getallDocuments',[$userss->id,'All','Corporate'])}}">{{ Helper::getexpDocuments($userss->id,"Central","2","Corporate","License")  +  Helper::getDocuments($userss->id, 'Central', 'Corporate','License') }}</a></span></li>
        </ul>
        <div class="iconbx">
        ...
        <div class="historyLink">
            <a href="{{route('allUnitHistory',[$userss->id,'Corporate'])}}">History</a>
        </div>
    </div>
    ...
    <div class="fssaiListing hraListing">
        ...
        <div class="fssaicntbx">
        <ul>
            <li><strong>Total Unit:</strong> <span><a href="{{route('getallDocuments',[$userss->id,'All','Corporate'])}}?document_type=HRA">{{ Helper::getexpDocuments($userss->id,"Central","2","Corporate","HRA")  +  Helper::getDocuments($userss->id, 'Central', 'Corporate','HRA') }}</a></span> ( Uploaded:<span>0</span>, Not Uploaded:<span><a href="{{ route('units', [$userss->id, '1', 'pending']) }}?document_type=HRA">
                                       {{ Helper::units($userss->id, '1', 'pending','HRA') }}
                                       </a></span> )</li>
            <li><strong>Valid:</strong> <span><a href="{{ route('getDocuments', [$userss->id, 'Central', 'Corporate']) }}?document_type=HRA">
                                          {{ Helper::getDocuments($userss->id, 'Central', 'Corporate','HRA') }}
                                          </a></span>Near Expiry:<span><a href="{{ route('getexpDocuments', [$userss->id, 'Central', '1', 'Corporate']) }}?document_type=HRA">
                                          {{ Helper::getexpDocuments($userss->id, 'Central', '1', 'Corporate','HRA') }}
                                          </a></span>, NA:<span><a href="{{route('getallDocuments',[$userss->id,'NA','Corporate'])}}?document_type=HRA">{{ Helper::totalDocuments($userss->id, 'NA', 'Corporate','HRA') }}</a></span></li>
            <li><strong>Expired:</strong> <span><a href="{{ route('getexpDocuments', [$userss->id, 'Central', '2', 'Corporate']) }}?document_type=HRA">
    ...
    <div class="fssaiListing tpaListing">
        ...
        <div class="fssaicntbx">
            <ul>
                <li><strong>Total Unit:</strong> <span><a href="{{route('getallDocuments',[$userss->id,'All','Corporate'])}}?document_type=TPA">{{ Helper::getexpDocuments($userss->id,"Central","2","Corporate","TPA")  +  Helper::getDocuments($userss->id, 'Central', 'Corporate','TPA') }}</a></span> ( Uploaded:<span>0</span>, Not Uploaded:<span><a href="{{ route('units', [$userss->id, '1', 'pending']) }}?document_type=TPA">
                  {{ Helper::units($userss->id, '1', 'pending','TPA') }}
                  </a></span> )</li>
                <li><strong>Valid:</strong> <a href="{{ route('getDocuments', [$userss->id, 'Central', 'Corporate']) }}?document_type=TPA">
                                             {{ Helper::getDocuments($userss->id, 'Central', 'Corporate','TPA') }}
                                             </a>  ( Near Expiry:<span><a href="{{ route('getexpDocuments', [$userss->id, 'Central', '1', 'Corporate']) }}?document_type=TPA">
                                             {{ Helper::getexpDocuments($userss->id, 'Central', '1', 'Corporate','TPA') }}
                                             </a></span>, NA: <span><a href="{{route('getallDocuments',[$userss->id,'NA','Corporate'])}}?document_type=TPA">{{ Helper::totalDocuments($userss->id, 'NA', 'Corporate','TPA') }}</a></span></li>
                <li><strong>Expired:</strong> <span><a href="{{ route('getexpDocuments', [$userss->id, 'Central', '2', 'Corporate']) }}?document_type=TPA">
        ...
        <div class="historyLink">
            <a href="{{route('allUnitHistory',[$userss->id,'Corporate'])}}?document_type=TPA">History</a>
        </div>
    </div>
    ...
    <div class="fssaiListing fostacListing">
        ...
        <div class="fssaicntbx">
            ...
            <ul>
                <li><strong>Total Unit:</strong> <span>33</span> ( Compliance: <span> <a href="{{ route('unitsFoSTaC', [$userss->id, '1', 'pending', 'Corporate']) }}?document_type=FoSTaC&Compliance=Compliance">
                    {{ Helper::unitsFoSTaC($userss->id, '1') }}
                    </a></span>, Not Compliance :<span><a href="{{ route('unitsFoSTaC', [$userss->id, '1', 'pending', 'Corporate']) }}?document_type=FoSTaC&Compliance=NotCompliance">
                ...
                <li><strong>Total Certificate:</strong> <span><a href="{{route('getFoSTaCDocuments',[$userss->id,1,'Corporate'])}}">{{$totalEmployeDocuments ?? 0}}</a></span> (Valid: <span><a href="{{route('getFoSTaCDocuments',[$userss->id,2,'Corporate'])}}">
                    {{$getFoSTaCValidDocuments ?? 0}}
                    </a> </span> ( Near Expiry:<span><a href="{{route('getFoSTaCDocuments',[$userss->id,3,'Corporate'])}}">
...
<div class="viewResionalBtn"><a href="#" class="viewResionalBtn" onclick="openRegional({{$userss->id ?? ''}})">View Regional</a></div>
</div>
...
<div class="corporateManageBx">
            <div class="corporManagHead">
               <ul>
                  <li>
                     <label>Corporate Name:</label>
                     <span>Marriott Hotel <a data-bs-toggle="modal" data-bs-target="#editcompanydetails40"> <i class="font-20 bx bxs-edit"></i></a></span>
                  </li>

                  <li>
                     <label>Contact Person Name:</label>
                     <span>Mr. Executive Chef</span>
                  </li>

                  <li>
                     <label>Designation:</label>
                     <span>Corporate Executive Chef</span>
                  </li>

                  <li>
                     <label>Email:</label>
                     <span>m1@gmail.com</span>
                  </li>

                  <li>
                     <label>Company Number:</label>
                     <span>9610523667</span>
                  </li>
               </ul>
            </div>
            <div class="tableHeadTitle">
    ...
    <div class="fssaiListing">
        ...
        <div class="fssaicntbx">
        <ul>
            <li><strong>Total Unit:</strong> <span>33</span> ( Uploaded:<span>0</span>, Not Uploaded:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/units/40/1/pending">1</a></span> )</li>
            <li><strong>Valid:</strong> <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getDocuments/40/Central/Corporate">0 </a></span> ( Near Expiry:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getexpDocuments/40/Central/1/Corporate">0</a></span>, C:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getallDocuments/40/Central/Corporate">2</a></span>, S:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getallDocuments/40/State/Corporate">0</a></span> )</li>
            <li><strong>Expired:</strong> <span>      <a href="https://efsm.safefoodmitra.com/admin/public/index.php/getallDocuments/40/All/Corporate">2</a></span></li>
        </ul>
        <div class="iconbx">
        <i class="bx bxs-id-card"></i>
        </div>
        ...
        <div class="historyLink">
            <a href="https://efsm.safefoodmitra.com/admin/public/index.php/all-unit-history/40/Corporate">History</a>
        </div>
    </div>
    ...
    <div class="fssaiListing hraListing">
        ...
        <div class="fssaicntbx">
        <ul>
            <li><strong>Total Unit:</strong> <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getallDocuments/40/All/Corporate?document_type=HRA">1</a></span> ( Uploaded:<span>0</span>, Not Uploaded:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/units/40/1/pending?document_type=HRA">
                                       0
                                       </a></span> )</li>
            <li><strong>Valid:</strong> <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getDocuments/40/Central/Corporate?document_type=HRA">
                                          0
                                          </a></span>Near Expiry:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getexpDocuments/40/Central/1/Corporate?document_type=HRA">
                                          0
                                          </a></span>, NA:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getallDocuments/40/NA/Corporate?document_type=HRA">0</a></span></li>
            <li><strong>Expired:</strong> <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getexpDocuments/40/Central/2/Corporate?document_type=HRA">
                                       1
                                       </a></span></li>
        </ul>
        <div class="iconbx">
    ...
    <div class="fssaiListing tpaListing">
        ...
        <div class="fssaicntbx">
            <ul>
                <li><strong>Total Unit:</strong> <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getallDocuments/40/All/Corporate?document_type=TPA">0</a></span> ( Uploaded:<span>0</span>, Not Uploaded:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/units/40/1/pending?document_type=TPA">
                  1
                  </a></span> )</li>
                <li><strong>Valid:</strong> <a href="https://efsm.safefoodmitra.com/admin/public/index.php/getDocuments/40/Central/Corporate?document_type=TPA">
                                             0
                                             </a>  ( Near Expiry:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getexpDocuments/40/Central/1/Corporate?document_type=TPA">
                                             0
                                             </a></span>, NA: <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getallDocuments/40/NA/Corporate?document_type=TPA">0</a></span></li>
                <li><strong>Expired:</strong> <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getexpDocuments/40/Central/2/Corporate?document_type=TPA">
                  0
                  </a></span></li>
            </ul>
            <div class="iconbx">
        ...
        <div class="historyLink">
            <a href="https://efsm.safefoodmitra.com/admin/public/index.php/all-unit-history/40/Corporate?document_type=TPA">History</a>
        </div>
    </div>
    ...
    <div class="fssaiListing fostacListing">
        ...
        <div class="fssaicntbx">
            ...
            <ul>
                <li><strong>Total Unit:</strong> <span>33</span> ( Compliance: <span> <a href="https://efsm.safefoodmitra.com/admin/public/index.php/FoSTaC-units/40/1/pending/Corporate?document_type=FoSTaC&amp;Compliance=Compliance">
                    0
                    </a></span>, Not Compliance :<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/FoSTaC-units/40/1/pending/Corporate?document_type=FoSTaC&amp;Compliance=NotCompliance">
                    2
                    </a></span>)</li>
                <li><strong>Food Handlers Count:</strong> <span>1</span>: Certificate Required: 0.04 </li>
                <li><strong>Total Certificate:</strong> <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getFoSTaCDocuments/40/1/Corporate">0</a></span> (Valid: <span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getFoSTaCDocuments/40/2/Corporate">
                    0
                    </a> </span> ( Near Expiry:<span><a href="https://efsm.safefoodmitra.com/admin/public/index.php/getFoSTaCDocuments/40/3/Corporate">
                    0
                    </a></span> )</li>
                <li><strong>Expired:</strong> <span><a href="">
                    0
...
<div class="viewResionalBtn"><a href="#" class="viewResionalBtn" onclick="openRegional(40)">View Regional</a></div>
</div>
<!-- End -->
...
<!-- End -->
 ...
 <!--end row-->
               ...
               <thead>
               <tr>
               <th ><span>Regional Name :</span>{{$regionals->login_id ?? ''}}<a data-bs-toggle="modal" data-bs-target="#editregionalcompanydetails{{$regionals->id}}"> <i class="font-20 bx bxs-edit"></i></a></th>
...
<!-- End -->
               ...
               {{ Helper::unitsFoSTaC($regionals->id, '2') }}
                                 ...
                                 <div class="modal fade" id="editregionalcompanydetails{{$regionals->id}}" tabindex="-1" aria-hidden="true">
               <div class="modal-dialog modal-dialog-centered modal-lg">
               <div class="modal-content">
               <div class="modal-header">
               <h5 class="modal-title">Edit  Details</h5>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <div class="modal-body">
                       ...
                       @csrf
                       <div class="row">
                       <input type="hidden" name="id" value="{{$regionals->id}}">
                       <div class="mb-3 col-md-6">
                       <label class="form-label">Corporate ID:</label>
                       <input type="text" class="form-control"  name="login_id" placeholder="" value="{{$regionals->login_id}}">
                       @if($errors->has('login_id'))
                       <div class="error">{{ $errors->first('login_id') }}</div>
                       @endif
                       </div>
                       <div class="mb-3 col-md-6">
                       <label class="form-label">Company Name:</label>
                       <input type="text" class="form-control"  name="company_name" placeholder="" value="{{$regionals->company_name}}">
                       @if($errors->has('company_name'))
                       <div class="error">{{ $errors->first('company_name') }}</div>
                       @endif
                       </div>
                       ...
                       <label class="form-label">Company Address
                       :</label>
                       <input type="text" class="form-control"  name="Company_address" placeholder="" value="{{$regionals->Company_address}}">
                       @if($errors->has('Company_address'))
                       <div class="error">{{ $errors->first('Company_address') }}</div>
                       @endif
                       </div>
                       <div class="mb-3 col-md-6">
                       <label class="form-label">Contact Person Name:</label>
                       <input type="text" class="form-control"  name="Contact_Person_Name" placeholder="" value="{{$regionals->Contact_Person_Name}}">
                       @if($errors->has('login_id'))
                       <div class="error">{{ $errors->first('login_id') }}</div>
                       @endif
                       </div>
                       <div class="mb-3 col-md-6">
                       <label class="form-label">Designation:</label>
                       <input type="text" class="form-control"  name="designation" placeholder="" value="{{$regionals->designation}}">
                       @if($errors->has('designation'))
                       <div class="error">{{ $errors->first('designation') }}</div>
                       @endif
                       </div>
                       <div class="mb-3 col-md-6">
                       <label class="form-label">Enter Full Name </label>
                       <input type="text" name="name" class="form-control" placeholder="" value="{{$regionals->name}}">
                       @if($errors->has('name'))
                       <div class="error">{{ $errors->first('name') }}</div>
                       @endif
                       </div>
                       <div class="mb-3 col-md-6">
                       <label class="form-label">Enter Email </label>
                       <input type="email" name="email" class="form-control" placeholder="" value="{{$regionals->email}}">
                       @if($errors->has('email'))
                       <div class="error">{{ $errors->first('email') }}</div>
                       @endif
                       </div>
                       <div class="mb-3 col-md-6">
                       <label class="form-label">Enter Mobile Number </label>
                       <input type="text" name="mobile_number" class="form-control" placeholder="" value="{{$regionals->mobile_number}}">
                       @if($errors->has('mobile_number'))
                       <div class="error">{{ $errors->first('mobile_number') }}</div>
                       @endif
                       </div>
               ...
               <thead>
               <tr>
               <th style="background: #f74c4c;"><span>Unit Name:</span>{{$userss->login_id ?? ''}} <a data-bs-toggle="modal" data-bs-target="#editunitcompanydetails{{$userss->id}}"> <i class="font-20 bx bxs-edit"></i></a></th>
               ...
               {{ Helper::unitsFoSTaC($userss->id, '2') }}
                                   ...
                                   <div class="modal fade" id="editunitcompanydetails{{$userss->id}}" tabindex="-1" aria-hidden="true">
               <div class="modal-dialog modal-dialog-centered modal-lg">
               <div class="modal-content">
               <div class="modal-header">
               <h5 class="modal-title">Edit  Details</h5>
